...
- [4. Amazon ALB](4. ELB/4. Amazon ALB.md): Các đặc điểm chi tiết của dòng Application Load Balancer hoạt động tại Layer 7 (Ưu thế định tuyến theo Path, Host, thuộc tính Request, tích hợp Container/Lambda và Custom HTTP Response).
