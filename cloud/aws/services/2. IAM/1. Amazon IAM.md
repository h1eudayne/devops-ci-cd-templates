...
## II. Các khái niệm cốt lõi (IAM Concept)
...
*   **User**: Đại diện cho một người dùng hoặc một ứng dụng cụ thể cần tương tác với AWS.
*   **Group**: Tập hợp các IAM Users để quản lý phân quyền theo nhóm một cách hiệu quả.
*   **Role**: Vai trò ảo chứa các quyền hạn ngắn hạn, có thể được giả lập (assume) bởi người dùng hoặc các dịch vụ AWS khác.
*   **Permission (Policy)**: Chính sách phân quyền (tài liệu JSON) quy định cụ thể hành động nào được phép (Allow) hoặc bị cấm (Deny) trên tài nguyên nào.

---

## III. Các Use Case Của Amazon IAM
