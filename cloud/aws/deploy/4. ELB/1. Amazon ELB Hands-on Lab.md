...
4. **Cấu hình kịch bản tự động hóa (User Data) cho Instance A**:
   ...
   * Tìm trường cấu hình **User data** ở dưới cùng và dán đoạn script Bash sau (để hiển thị tiêu đề màu xanh dương - **Blue**):
...
Thực hiện tương tự các bước trên để tạo instance thứ hai:
...
3. **Cấu hình kịch bản tự động hóa (User Data) cho Instance B**:
   * Tại mục **Advanced Details** -> **User data**, dán đoạn script Bash sau (để hiển thị tiêu đề màu xanh lá - **Green**):
...
### Bước 5: Tạo Target Group (`tg-a1`) và đăng ký Targets
...
### Bước 6: Tạo Application Load Balancer (ALB)
...
6. **Listeners and routing**:
   * **Protocol & Port**: Chọn **HTTP** trên Port **80**.
   * **Default action**: Chọn hành động **Forward to** và trỏ tới Target Group **`tg-a1`** vừa tạo ở Bước 5.
7. Nhấp chọn **Create load balancer**.

---

### Bước 7: Kiểm tra tính năng Load Balancing
